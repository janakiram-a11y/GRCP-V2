...
export const academicCalendarItems = [
  ...
  { label: 'GRCP: Approvals and Recognitions',    href: BASE + 'downloads/Approvals and Recognitions.pdf'    },
  { label: 'Teaching Learning Methods',           href: BASE + 'downloads/Teaching Learning Methods.pdf'     },
  { label: 'Student Support and Progression',     href: BASE + 'downloads/Student Support and Progression.pdf' },
  { label: 'Alumni Registration',                 href: BASE + 'downloads/Alumni Registration.pdf'           },
  { label: 'Distinguished Alumni',                href: BASE + 'downloads/Distinguished Alumni.pdf'          },
]
...
export const titleVolumes = {
  ...
  total: 539,
  subjects: [
    { name: 'Pharmacology',            copies: 127 },
    { name: 'Pharmaceutics',           copies: 61  },
    { name: 'Chemistry',               copies: 35  },
    { name: 'Pharmaceutical Analysis', copies: 32  },
    { name: 'Pharmacognosy',           copies: 22  },
    { name: 'Biochemistry',            copies: 15  },
    { name: 'Biotechnology',           copies: 16  },
    { name: 'General / Career Development', copies: 11 },
  ],
}
